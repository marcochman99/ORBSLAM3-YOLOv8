...
struct YoloV8Config {
    ...
    float probabilityThreshold = 0.25f;             //0.65f
    // Non-maximum suppression threshold
    float nmsThreshold = 0.65f;                     //0.65f
    ...
    int segH = 160;
    int segW = 160;
    float segmentationThreshold = 0.15f;        //was 0.25f  //was 0.5f
...
public:
    ...
    //bool tickoffChecck(cv::Point& pt);
    //bool tickoffCheck();    
    
    int tickoffCheck(float x, float y);		
